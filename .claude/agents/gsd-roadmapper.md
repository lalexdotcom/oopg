...
Reference full template: `/workspaces/oopg/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/workspaces/oopg/.claude/get-shit-done/templates/state.md`.
