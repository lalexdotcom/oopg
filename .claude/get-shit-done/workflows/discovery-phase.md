...
See /workspaces/oopg/.claude/get-shit-done/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using /workspaces/oopg/.claude/get-shit-done/templates/discovery.md structure:
...
1. **Scope the discovery** using /workspaces/oopg/.claude/get-shit-done/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from /workspaces/oopg/.claude/get-shit-done/templates/discovery.md
...
Use /workspaces/oopg/.claude/get-shit-done/templates/discovery.md.
