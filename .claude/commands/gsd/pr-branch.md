...
<execution_context>
@/workspaces/oopg/.claude/get-shit-done/workflows/pr-branch.md
</execution_context>

<process>
Execute the pr-branch workflow from @/workspaces/oopg/.claude/get-shit-done/workflows/pr-branch.md end-to-end.
</process>
