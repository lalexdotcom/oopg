...
<execution_context>
@/workspaces/oopg/.claude/get-shit-done/workflows/new-workspace.md
@/workspaces/oopg/.claude/get-shit-done/references/ui-brand.md
</execution_context>

<process>
Execute the new-workspace workflow from @/workspaces/oopg/.claude/get-shit-done/workflows/new-workspace.md end-to-end.
